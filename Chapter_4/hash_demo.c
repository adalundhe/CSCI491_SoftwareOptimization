 ...
 */
unsigned int hashpop, hashlimit, hashprime = 1000 ;
struct node **hashtab ;
/*
...
void resize() {
   ...
   nhashtab = (struct node **)malloc(nhashprime * sizeof(struct node *)) ;
...
struct node *newnode() {
   ...
   if (freenodes == 0) {
      int i ;
      freenodes = malloc(1001 * sizeof(struct node)) ;
...
struct leaf *newleaf() {
   ...
   if (freeleaves == 0) {
      int i ;
      freeleaves = malloc(1001 * sizeof(struct leaf)) ;
 ...
 */
   ...
   hashlimit = hashprime ;
   hashtab = malloc(hashprime * sizeof(struct node *)) ;
...
int *getnummem(int n) {
   ...
   while (currentnummem == 0 || numleft < n) {
      ...
      if (currentnummem == 0) {
         currentnummem = malloc(1 * sizeof(struct numalloc)) ;
...
void do_gc(int why) {
   ...
   fprintf(stderr, "%u]", hashpop/(totalthings/100)) ;
}
/*
